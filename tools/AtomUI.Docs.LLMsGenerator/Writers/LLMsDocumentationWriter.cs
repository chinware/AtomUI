...
public static class LLMsDocumentationWriter
{
    public static IReadOnlyList<GeneratedLLMsFile> WriteAll(IReadOnlyList<ControlDocModel> models)
    {
        ...
        files.Add(new GeneratedLLMsFile("docs/generated/llms/llms.txt", LLMsIndexWriter.Write(models)));
        files.Add(new GeneratedLLMsFile("docs/generated/llms/llms-full-cn.txt",
            LLMsAggregateWriter.Write("AtomUI Desktop Controls Full CN", files, "index-cn.md")));
        files.Add(new GeneratedLLMsFile("docs/generated/llms/llms-semantic-cn.md",
    ...
    private static void PruneStaleGeneratedFiles(string repositoryRoot, IReadOnlyList<GeneratedLLMsFile> files)
    {
        ...
        var outputRoot = Path.Combine(repositoryRoot, "docs/generated/llms");
    ...
    {
        return path is "docs/generated/llms/llms.txt" or "docs/generated/llms/llms-full-cn.txt" or "docs/generated/llms/llms-semantic-cn.md" ||
               path.StartsWith("docs/generated/llms/controls/", StringComparison.Ordinal);
    }
}
