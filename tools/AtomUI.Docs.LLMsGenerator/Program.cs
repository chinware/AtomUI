...
{
    private const string DefaultConfigPath = "docs/AI/llms.config.json";
    ...
    private static void PrintUsage()
    {
        ...
        Console.WriteLine("  dotnet run --project tools/AtomUI.Docs.LLMsGenerator/AtomUI.Docs.LLMsGenerator.csproj -- generate --config docs/AI/llms.config.json");
        Console.WriteLine("  dotnet run --project tools/AtomUI.Docs.LLMsGenerator/AtomUI.Docs.LLMsGenerator.csproj -- verify --config docs/AI/llms.config.json");
    }
}
