...
internal static partial class Program
{
        private static string RenderTable(IReadOnlyList<PerfResult> results)
        {
            ...
            builder.AppendLine("Scenario                                Count  Total ms  ms/item  KB/item  Visual  Logical  CP Space  CSp CSpIt CSpAO  Button IconBtn  TB Panel Border Dock  Icon  IconP STIconP BtnIconP  PathI  Stack  Wave Dashed LoadHost BtnSpin BSpinBox BSpinH BSpinCP Card CardAP CardBtn CardMeta CardGrid CardGI CardTabs Skeleton SkelAv SkelTitle SkelPara SkelLine  AODB Select TreeSel Cascader ComboBox SelHandle SelHost SelList SelFilter SelResult SelTags TreeView CascView Popup AutoC ACSearch ACTArea CandList ACPopFld ACCandFld Avatar AvGroup Image Svg Flyout CBadge DBadge RBadge CBAd DBAd RBAd DotInd Motion Label  IconUpdates  BrushCalls  Scanned");
            builder.AppendLine("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
            ...
            foreach (var result in results)
            {
                ...
                builder.Append(CultureInfo.InvariantCulture,
                    $"{result.TreeStats.CardPerRoot,5:0.0}{result.TreeStats.CardActionPanelPerRoot,7:0.0}{result.TreeStats.CardActionButtonPerRoot,8:0.0}{result.TreeStats.CardMetaContentPerRoot,9:0.0}{result.TreeStats.CardGridContentPerRoot,9:0.0}{result.TreeStats.CardGridItemPerRoot,7:0.0}{result.TreeStats.CardTabsContentPerRoot,9:0.0}{result.TreeStats.SkeletonPerRoot,9:0.0}{result.TreeStats.SkeletonAvatarPerRoot,7:0.0}{result.TreeStats.SkeletonTitlePerRoot,10:0.0}{result.TreeStats.SkeletonParagraphPerRoot,9:0.0}{result.TreeStats.SkeletonLinePerRoot,9:0.0}");
                builder.Append(CultureInfo.InvariantCulture,
        ...
        private static string RenderMarkdown(IReadOnlyList<PerfResult> results, PerfOptions options)
        {
            ...
            foreach (var result in results)
            {
                ...
                builder.Append(CultureInfo.InvariantCulture,
                    $"{result.TreeStats.CardPerRoot:0.0} | {result.TreeStats.CardActionPanelPerRoot:0.0} | {result.TreeStats.CardActionButtonPerRoot:0.0} | {result.TreeStats.CardMetaContentPerRoot:0.0} | {result.TreeStats.CardGridContentPerRoot:0.0} | {result.TreeStats.CardGridItemPerRoot:0.0} | {result.TreeStats.CardTabsContentPerRoot:0.0} | {result.TreeStats.SkeletonPerRoot:0.0} | {result.TreeStats.SkeletonAvatarPerRoot:0.0} | {result.TreeStats.SkeletonTitlePerRoot:0.0} | {result.TreeStats.SkeletonParagraphPerRoot:0.0} | {result.TreeStats.SkeletonLinePerRoot:0.0} | {result.TreeStats.AddOnDecoratedBoxPerRoot:0.0} | ");
                builder.Append(CultureInfo.InvariantCulture,
