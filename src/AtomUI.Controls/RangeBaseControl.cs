...
/// </summary>
public abstract class RangeBaseControl : StyledControl
{
   ...
   public static readonly StyledProperty<double> MinimumProperty =
      AvaloniaProperty.Register<RangeBaseControl, double>(nameof(Minimum), coerce: CoerceMinimum);

   /// <summary>
   /// Defines the <see cref="Maximum"/> property.
   /// </summary>
   public static readonly StyledProperty<double> MaximumProperty =
      AvaloniaProperty.Register<RangeBaseControl, double>(nameof(Maximum), 100, coerce: CoerceMaximum);
   ...
   public static readonly StyledProperty<double> SmallChangeProperty =
      AvaloniaProperty.Register<RangeBaseControl, double>(nameof(SmallChange), 1);

   /// <summary>
   /// Defines the <see cref="LargeChange"/> property.
   /// </summary>
   public static readonly StyledProperty<double> LargeChangeProperty =
      AvaloniaProperty.Register<RangeBaseControl, double>(nameof(LargeChange), 10);
   ...
   public static readonly RoutedEvent<RangeBaseValueChangedEventArgs> ValueChangedEvent =
      RoutedEvent.Register<RangeBaseControl, RangeBaseValueChangedEventArgs>(
