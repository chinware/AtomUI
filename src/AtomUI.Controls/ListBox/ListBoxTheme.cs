...
internal class ListBoxTheme : BaseControlTheme
{
   ...
   protected override IControlTemplate BuildControlTemplate()
   {
      return new FuncControlTemplate<ListBox>((listBox, scope) =>
      {
         ...
         CreateTemplateParentBinding(frameBorder, Border.BackgroundProperty, ListBox.BackgroundProperty);
         CreateTemplateParentBinding(frameBorder, Border.BorderBrushProperty, ListBox.BorderBrushProperty);
         CreateTemplateParentBinding(frameBorder, Border.BorderThicknessProperty, ListBox.BorderThicknessProperty);
         CreateTemplateParentBinding(frameBorder, Border.CornerRadiusProperty, ListBox.CornerRadiusProperty);
   ...
   private ItemsPresenter BuildItemsPresenter(ListBox listBox, INameScope scope)
   {
      ...
      CreateTemplateParentBinding(itemsPresenter, ItemsPresenter.ItemsPanelProperty, ListBox.ItemsPanelProperty);
   ...
   private void BuildCommonStyle()
   {
      ...
      frameStyle.Add(Border.PaddingProperty, ListBoxTokenResourceKey.ContentPadding);
