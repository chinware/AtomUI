...
internal class PrimaryButtonTheme : BaseButtonTheme
{
   ...
   private void BuildEnabledStyle()
   {
      ...
      // 正常状态
      enabledStyle.Add(new Setter(Button.ForegroundProperty, new DynamicResourceExtension(ButtonResourceKey.PrimaryColor)));
      enabledStyle.Add(new Setter(Button.BackgroundProperty, new DynamicResourceExtension(GlobalResourceKey.ColorPrimary)));
      
      // 正常 hover
      {
         var hoverStyle = new Style(selector => selector.Nesting().Class(StdPseudoClass.PointerOver));
         hoverStyle.Add(new Setter(Button.BackgroundProperty, new DynamicResourceExtension(GlobalResourceKey.ColorPrimaryHover)));
      ...
      // 正常按下
      {
         ...
         pressedStyle.Add(new Setter(Button.BackgroundProperty, new DynamicResourceExtension(GlobalResourceKey.ColorPrimaryActive)));
      ...
      dangerStyle.Add(new Setter(Button.BackgroundProperty, new DynamicResourceExtension(GlobalResourceKey.ColorError)));
      
      // 危险状态 hover
      {
         var hoverStyle = new Style(selector => selector.Nesting().Class(StdPseudoClass.PointerOver));
         hoverStyle.Add(new Setter(Button.BackgroundProperty, new DynamicResourceExtension(GlobalResourceKey.ColorErrorHover)));
      ...
      {
         var pressedStyle = new Style(selector => selector.Nesting().Class(StdPseudoClass.PointerOver).Class(StdPseudoClass.Pressed));
         pressedStyle.Add(new Setter(Button.BackgroundProperty, new DynamicResourceExtension(GlobalResourceKey.ColorErrorActive)));
   ...
   private void BuildEnabledGhostStyle()
   {
      ...
      ghostStyle.Add(new Setter(Button.BackgroundProperty, new SolidColorBrush(Colors.Transparent)));
      
      // 正常状态
      ghostStyle.Add(new Setter(Button.ForegroundProperty, new DynamicResourceExtension(GlobalResourceKey.ColorPrimary)));
      ghostStyle.Add(new Setter(Button.BorderBrushProperty, new DynamicResourceExtension(GlobalResourceKey.ColorPrimary)));
