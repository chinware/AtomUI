...
public class ArrowDecoratedMenuFlyoutPresenter : MenuBase
{
   #region 公共属性定义

   public static readonly StyledProperty<bool> IsShowArrowProperty =
      ArrowDecoratedBox.IsShowArrowProperty.AddOwner<ArrowDecoratedMenuFlyoutPresenter>();

   public static readonly StyledProperty<ArrowPosition> ArrowPositionProperty =
      ArrowDecoratedBox.ArrowPositionProperty.AddOwner<ArrowDecoratedMenuFlyoutPresenter>();
   ...
   public ArrowDecoratedMenuFlyoutPresenter()
      : base(new DefaultMenuInteractionHandler(true)) { }

   public ArrowDecoratedMenuFlyoutPresenter(IMenuInteractionHandler menuInteractionHandler)
