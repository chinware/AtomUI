...
internal class PopupConfirmContainerTheme : BaseControlTheme
{
   ...
   protected override IControlTemplate BuildControlTemplate()
   {
      return new FuncControlTemplate<PopupConfirmContainer>((popupConfirmContainer, scope) =>
      {
         ...
         TokenResourceBinder.CreateTokenBinding(mainLayout, DockPanel.MinWidthProperty,
                                                PopupConfirmTokenResourceKey.PopupMinWidth);
         TokenResourceBinder.CreateTokenBinding(mainLayout, DockPanel.MinHeightProperty,
   ...
   private DockPanel BuildContent(PopupConfirmContainer popupConfirmContainer, INameScope scope)
   {
      ...
      CreateTemplateParentBinding(iconContentPresenter, ContentPresenter.IsVisibleProperty,
                                  PopupConfirmContainer.IconProperty,
                                  BindingMode.Default,
   ...
   private StackPanel BuildButtons(PopupConfirmContainer popupConfirmContainer, INameScope scope)
   {
      ...
      TokenResourceBinder.CreateTokenBinding(cancelButton, Button.MarginProperty,
      ...
      CreateTemplateParentBinding(cancelButton, Button.IsVisibleProperty,
      ...
      TokenResourceBinder.CreateTokenBinding(okButton, Button.MarginProperty,
                                             PopupConfirmTokenResourceKey.ButtonContainerMargin);
