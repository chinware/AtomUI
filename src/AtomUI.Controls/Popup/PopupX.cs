...
//         AvaloniaProperty.Register<PopupX, CustomPopupPlacementCallback?>(nameof(CustomPopupPlacementCallback));
//
//     /// <summary>
...
//         AvaloniaProperty.RegisterAttached<PopupX, Control, bool>(nameof(TakesFocusFromNativeControl), true);
//
...
//         IsOpenProperty.Changed.AddClassHandler<PopupX>((x, e) =>
...
//
//     /// <summary>
//     /// Gets or sets a delegate handler method that positions the PopupX control, when <see cref="Placement"/> is set to <see cref="PlacementMode.Custom"/>.
//     /// </summary>
