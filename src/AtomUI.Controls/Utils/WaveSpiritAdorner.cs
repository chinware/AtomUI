...
internal class WaveSpiritAdorner : Control
{
   ...
   private Size _lastWaveSize = default!;
   ...
   protected readonly static DirectProperty<WaveSpiritAdorner, double> LastWaveOpacityProperty
   ...
   protected readonly static DirectProperty<WaveSpiritAdorner, Size> LastWaveSizeProperty
   ...
   protected readonly static DirectProperty<WaveSpiritAdorner, double> LastWaveRadiusProperty
      = AvaloniaProperty.RegisterDirect<WaveSpiritAdorner, double>(
   ...
   {
      if (args.Property == Control.BoundsProperty) {
         AdjustWaveAdorner();
      }
   }
   ...
   {
      if (_adornerCache.TryGetValue(target, out WaveSpiritAdorner? adorner)) {
         // 回调会清除项
         return;
      }
