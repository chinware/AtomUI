...
internal class DrawerLayer : Canvas
{
    ...
    public static readonly AttachedProperty<Visual?> AttachTargetElementProperty =
        AvaloniaProperty.RegisterAttached<DrawerLayer, Visual, Visual?>("AttachTargetElement");
    ...
    private void UpdateAttachTargetElement(Visual drawerContainer, Visual? attachTarget)
    {
        ...
        if (attachTarget != null)
        {
            ...
            {
                info.Bounds = new TransformedBounds(new Rect(attachTarget.Bounds.Size), new Rect(attachTarget.Bounds.Size),
                    Matrix.Identity);
                InvalidateMeasure();
            });
        }
    ...
    private static void HandleAttachTargetElementChanged(AvaloniaPropertyChangedEventArgs<Visual?> e)
    {
