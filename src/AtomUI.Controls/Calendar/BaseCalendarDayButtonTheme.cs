...
internal class BaseCalendarDayButtonTheme : BaseControlTheme
{
    ...
    protected override void BuildStyles()
    {
        ...
        commonStyle.Add(Layoutable.WidthProperty, CalendarTokenKey.CellWidth);
        commonStyle.Add(Layoutable.HeightProperty, CalendarTokenKey.CellHeight);
        commonStyle.Add(Layoutable.MarginProperty, CalendarTokenKey.CellMargin);

        var contentStyle = new Style(selector => selector.Nesting().Template().Name(ContentPart));
        contentStyle.Add(ContentPresenter.LineHeightProperty, CalendarTokenKey.CellLineHeight);
        commonStyle.Add(contentStyle);

        var hoverStyle = new Style(selector => selector.Nesting().Class(StdPseudoClass.PointerOver));
        hoverStyle.Add(TemplatedControl.BackgroundProperty, CalendarTokenKey.CellHoverBg);
