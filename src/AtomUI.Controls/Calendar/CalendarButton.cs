...
internal sealed class CalendarButton : AvaloniaButton
{
   ...
   protected override void OnPointerPressed(PointerPressedEventArgs e)
   {
      ...
      if (e.GetCurrentPoint(this).Properties.IsLeftButtonPressed) CalendarLeftMouseButtonDown?.Invoke(this, e);
   }
   ...
   protected override void OnPointerReleased(PointerReleasedEventArgs e)
   {
      ...
      if (e.InitialPressMouseButton == MouseButton.Left) CalendarLeftMouseButtonUp?.Invoke(this, e);
   }
}