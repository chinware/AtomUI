...
public sealed class DataGridCellsPresenter : Panel, IChildIndexProvider
{
    ...
    protected override Size ArrangeOverride(Size finalSize)
    {
        ...
        OwningRow?.FillerCell.Arrange(new Rect(_fillerLeftEdge, 0, OwningGrid.ColumnsInternal.FillerColumn.FillerWidth,
            finalSize.Height));

        return finalSize;
    }

    private static void EnsureCellClip(DataGridCell cell, double width, double height, double frozenLeftEdge,
                                       double cellLeftEdge)
    {
        ...
        if (cell.OwningColumn is not null && !cell.OwningColumn.IsFrozen && frozenLeftEdge > cellLeftEdge)
        {
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        foreach (DataGridColumn column in OwningGrid.ColumnsInternal.GetVisibleColumns())
        {
            ...
            bool shouldDisplayCell =
                ShouldDisplayCell(column, frozenLeftEdge, scrollingLeftEdge) || OwningRow!.Index == 0;
