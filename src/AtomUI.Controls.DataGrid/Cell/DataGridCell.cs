...
{
    private const string ElementRightGridLinePart = "PART_RightGridLine";
    ...
    private bool IsEdited => OwningGrid != null && OwningRow != null
    ...
    private bool IsMouseOver
    {
        ...
        set
        {
            if (value != IsMouseOver && OwningRow != null)
            {
                if (value)
                {
    ...
    {
        UpdatePseudoClasses();
        _rightGridLine = e.NameScope.Find<Rectangle>(ElementRightGridLinePart);
