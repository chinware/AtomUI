...
public abstract class DataGridColumn : AvaloniaObject
{
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        {
            OwningGrid?.NotifyColumnVisibleStateChanging(this);
            ...
            OwningGrid?.NotifyColumnVisibleStateChanged(this);
            ...
            if (_setWidthInternalNoCallback == false)
            {
                ...
                if (grid != null)
                {
                    ...
                    if (width.IsStar != oldWidth.IsStar)
                    {
                        ...
                        IsInitialDesiredWidthDetermined = false;
                        grid.NotifyColumnWidthChanged(this);
                    }
                    else
                    {
    ...
    public bool CanUserSort
    {
        get
        {
            ...
            else if (OwningGrid != null)
            {
                ...
                {
                    propertyType = propertyType.GetNonNullableType();
                }
        ...
        set
        {
            ...
            if (OwningGrid != null)
            {
                ...
                if (_displayIndexWithFiller != value)
                {
                    ...
                    {
                        throw DataGridError.DataGrid.ValueMustBeBetween(nameof(value), nameof(DisplayIndex), 0, true,
                            OwningGrid.Columns.Count, false);
                    }

                    // Will throw an error if a visible frozen column is placed inside a non-frozen area or vice-versa.
                    OwningGrid.NotifyColumnDisplayIndexChanging(this, value);
            ...
            else
            {
                if (value < -1)
                {
                    throw DataGridError.DataGrid.ValueMustBeGreaterThanOrEqualTo(nameof(value), nameof(DisplayIndex),
                        -1);
                }
    ...
    /// <summary>
    ///    Gets or sets the <see cref="DataGridError.DataGridColumnHeader"/> cell theme.
    /// </summary>
    ...
    /// <summary>
    ///    Gets or sets the <see cref="DataGridError.DataGridColumnHeader"/> content
    /// </summary>
    ...
    public virtual bool IsReadOnly
    {
        ...
        set
        {
            ...
            {
                OwningGrid?.NotifyColumnReadOnlyStateChanging(this, value);
                _isReadOnly = value;
            }
        }
    }
    ...
    public double MaxWidth
    {
        ...
        set
        {
            ...
            if (!_maxWidth.HasValue || !MathUtilities.AreClose(_maxWidth.Value, value))
            {
                double oldValue = ActualMaxWidth;
                _maxWidth = value;
                if (OwningGrid != null)
                {
                    OwningGrid.NotifyColumnMaxWidthChanged(this, oldValue);
                }
            }
        }
    }
    ...
    public double MinWidth
    {
        ...
        set
        {
            ...
            if (!_minWidth.HasValue || !MathUtilities.AreClose(_minWidth.Value, value))
            {
                ...
                if (OwningGrid != null)
                {
                    OwningGrid.NotifyColumnMinWidthChanged(this, oldValue);
                }
            }
        }
    }
    ...
    public Control? GetCellContent(DataGridRow dataGridRow)
    {
        ...
        {
            var dataGridCell = dataGridRow.Cells[Index];
    ...
    internal void Resize(DataGridLength oldWidth, DataGridLength newWidth, bool userInitiated)
    {
        ...
        {
            OwningGrid.NotifyColumnWidthChanged(this);
        }
    }
