...
internal class DataGridDataConnection
{
    ...
    public bool DataIsPrimitive => DataType is not null && DataTypeIsPrimitive(DataType);
    ...
    internal static IDataGridCollectionView CreateView(IDataGridCollectionViewFactory collectionViewFactory)
    {
    ...
    internal void MoveCurrentTo(object item, int backupSlot, int columnIndex, DataGridSelectionAction action,
                                bool scrollIntoView)
    {
        if (CollectionView != null)
        {
    ...
    private void NotifyingDataSource_CollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
        ...
        switch (e.Action)
        {
            ...
            case NotifyCollectionChangedAction.Remove:
                ...
                if (!IsGrouping && e.OldItems is not null)
                {
                    // If we're grouping then we handle this through the CollectionViewGroup notifications
