...
internal class DataGridColumnCollection : ObservableCollection<DataGridColumn>
{
    ...
    internal DataGridColumn? FirstVisibleColumn =>
        GetFirstColumn(true /*isVisible*/, null /*isFrozen*/, null /*isReadOnly*/);
    ...
    internal DataGridColumn? FirstVisibleWritableColumn =>
        GetFirstColumn(true /*isVisible*/, null /*isFrozen*/, false /*isReadOnly*/);

    internal DataGridColumn? FirstVisibleScrollingColumn =>
        GetFirstColumn(true /*isVisible*/, false /*isFrozen*/, null /*isReadOnly*/);

    internal List<DataGridColumn> ItemsInternal { get; private set; }

    internal DataGridColumn? LastVisibleColumn =>
        GetLastColumn(true /*isVisible*/, null /*isFrozen*/, null /*isReadOnly*/);

    internal DataGridColumn? LastVisibleScrollingColumn =>
        GetLastColumn(true /*isVisible*/, false /*isFrozen*/, null /*isReadOnly*/);

    internal DataGridColumn? LastVisibleWritableColumn =>
        GetLastColumn(true /*isVisible*/, null /*isFrozen*/, false /*isReadOnly*/);
    ...
    protected override void InsertItem(int columnIndex, DataGridColumn dataGridColumn)
    {
        try
        {
            ...
            _owningGrid.NotifyInsertedColumnPostNotification(newCurrentCellCoordinates, dataGridColumn.DisplayIndex);
            _owningGrid.NotifyColumnCollectionChangedPostNotification(true /*columnsGrew*/);
        }
        finally
        {
            _owningGrid.NoCurrentCellChangeCount--;
    ...
    {
        var column = GetPreviousColumn(dataGridColumnStart, true /*isVisible*/, null /*isFrozen*/,
            null /*isReadOnly*/);
