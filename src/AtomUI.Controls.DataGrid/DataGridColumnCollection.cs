...
internal class DataGridColumnCollection : ObservableCollection<DataGridColumn>
{
    ...
    protected override void ClearItems()
    {
        try
        {
            ...
            if (ItemsInternal.Count > 0)
            {
                ...
                _owningGrid.HandleClearingColumns();
    ...
    protected override void InsertItem(int columnIndex, DataGridColumn dataGridColumn)
    {
        try
        {
            ...
            if (dataGridColumn != RowGroupSpacerColumn && RowGroupSpacerColumn != null && RowGroupSpacerColumn.IsRepresented)
            {
                columnIndexWithFiller++;
            }

            // get the new current cell coordinates
            DataGridCellCoordinates newCurrentCellCoordinates = _owningGrid.HandleInsertingColumn(columnIndex, dataGridColumn);
            ...
            _owningGrid.HandleColumnCollectionChangedPreNotification(true /*columnsGrew*/);
