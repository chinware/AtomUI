...
public static class DataGridPseudoClass
{
    public const string EmptyRows = ":empty-rows";
    public const string EmptyColumns = ":empty-columns";
    ...
    public const string RowHover = ":row-hover";
}
