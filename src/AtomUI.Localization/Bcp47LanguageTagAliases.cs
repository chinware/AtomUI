...
internal static class Bcp47LanguageTagAliases
{
    ...
    private readonly record struct GrandfatheredTag(string Source, string PreferredValue);

    private readonly record struct SubtagAlias(string Source, string PreferredValue);
}
