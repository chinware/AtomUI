...
internal class RoundRectGeometryBuilder
{
        ...
        BackgroundSizing sizing)
    {
        ...
        var    topRightX = boundRect.Width - fRightTop;
        double topRightY = 0;

        var rightTopX = boundRect.Width;
        var rightTopY = fTopRight;

        var rightBottomX = boundRect.Width;
        var rightBottomY = boundRect.Height - fBottomRight;

        var bottomRightX = boundRect.Width - fRightBottom;
        var bottomRightY = boundRect.Height;

        var bottomLeftX = fLeftBottom;
        var bottomLeftY = boundRect.Height;

        double leftBottomX = 0;
        var    leftBottomY = boundRect.Height - fBottomLeft;

        double leftTopX = 0;
        var    leftTopY = fTopLeft;
        ...
        {
            var v = fLeftTop / (fLeftTop + fRightTop) * boundRect.Width;
            topLeftX  = v;
            topRightX = v;
        }
        ...
        {
            var v = fTopRight / (fTopRight + fBottomRight) * boundRect.Height;
            rightTopY    = v;
            rightBottomY = v;
        }
        ...
        {
            var v = fLeftBottom / (fLeftBottom + fRightBottom) * boundRect.Width;
            bottomRightX = v;
            bottomLeftX  = v;
        }
        ...
        {
            var v = fTopLeft / (fTopLeft + fBottomLeft) * boundRect.Height;
            leftBottomY = v;
            leftTopY    = v;
        }
        ...
        public RoundedRect ToRoundedRect()
        {
            return new RoundedRect(
                ...
                new Vector(
                    ...
                    LeftTop.Y - TopLeft.Y),
                new Vector(
                    RightTop.X - TopRight.X,
                    RightTop.Y - TopRight.Y),
                new Vector(
