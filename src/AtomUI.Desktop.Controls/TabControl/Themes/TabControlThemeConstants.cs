...
internal static class TabStripItemThemeConstants
{
    public const string ItemCloseButtonPart = "PART_ItemCloseButton";
}

internal static class TabStripThemeConstants
{
    ...
    public const string TabStripItemThemeId = "TabStripItemTheme";
    public const string CardTabStripItemThemeId = "CardTabStripItemTheme";
}

internal static class OverflowMenuItemThemeConstants
{
    public const string ItemCloseButtonPart = "PART_ItemCloseButton";
}

internal static class TabItemThemeConstants
{
    public const string ItemCloseButtonPart = "PART_ItemCloseButton";
    
    public const string TabItemThemeId = "TabItemTheme";
    public const string CardTabItemThemeId = "CardTabItemTheme";
}

internal static class TabControlThemeConstants
{
    public const string ItemsPresenterPart = "PART_ItemsPresenter";
    public const string TabsContainerPart = "PART_TabsContainer";
...
internal static class TabScrollViewerThemeConstants
{
