...
internal class ImageViewer : TemplatedControl, IMotionAwareControl
{
    ...
    private void ConstrainImagePosition()
    {
        if (_image != null)
        {
            ...
            if (MathUtils.LessThanOrClose(scaledImageWidth, Bounds.Width) && MathUtils.LessThanOrClose(scaledImageHeight, Bounds.Height))
            {
                _isSelfChangedPosition = false;
                if (!_isArrangeQueued)
                {
            ...
            {
                if (MathUtils.GreaterThan(scaledImageWidth, Bounds.Width))
                {
                ...
                if (MathUtils.GreaterThan(scaledImageHeight, Bounds.Height))
                {
