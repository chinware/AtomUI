...
internal static class BaseCalendarButtonThemeConstants
{
    public const string ContentPart = "PART_Content";
}

internal static class BaseCalendarDayButtonThemeConstants
{
    public const string ContentPart = "PART_Content";
}

internal static class CalendarItemThemeConstants    
{
...
internal static class HeadTextButtonThemeConstants
{
    public const string ContentPart = "PART_Content";
}

internal static class CalendarThemeConstants
{
