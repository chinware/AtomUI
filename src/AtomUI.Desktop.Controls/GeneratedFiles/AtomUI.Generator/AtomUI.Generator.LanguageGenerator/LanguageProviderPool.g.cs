...
namespace AtomUI.Theme.Language
{
    internal class LanguageProviderPool
    {
        internal static IList<LanguageProvider> GetLanguageProviders()
        {
            ...
            languageProviders.Add(new AtomUI.Desktop.Controls.DatePickerLang.zh_TW());
            ...
            languageProviders.Add(new AtomUI.Desktop.Controls.DialogLang.zh_TW());
            ...
            languageProviders.Add(new AtomUI.Desktop.Controls.ImagePreviewerLang.zh_TW());
            ...
            languageProviders.Add(new AtomUI.Desktop.Controls.PaginationLang.zh_TW());
            ...
            languageProviders.Add(new AtomUI.Desktop.Controls.QRCodeLang.zh_TW());
            ...
            languageProviders.Add(new AtomUI.Desktop.Controls.TimePickerLang.zh_TW());
            ...
            languageProviders.Add(new AtomUI.Desktop.Controls.TourLang.zh_TW());
            ...
            languageProviders.Add(new AtomUI.Desktop.Controls.TransferLang.zh_TW());
            ...
            languageProviders.Add(new AtomUI.Desktop.Controls.UploadLang.zh_TW());
