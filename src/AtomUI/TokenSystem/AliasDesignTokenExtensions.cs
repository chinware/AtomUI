...
public static class AliasDesignTokenExtensions
{
   public static void CalculateTokenValues(this AliasDesignToken aliasToken)
   {
      ...
      aliasToken.ColorSplit = ColorUtils.AlphaColor(colorNeutralToken.ColorBorderSecondary, colorNeutralToken.ColorBgContainer);
      ...
      aliasToken.ColorErrorOutline = ColorUtils.AlphaColor(colorErrorToken.ColorErrorBg, colorNeutralToken.ColorBgContainer);
      aliasToken.ColorWarningOutline = ColorUtils.AlphaColor(colorWarningToken.ColorWarningBg, colorNeutralToken.ColorBgContainer);
      ...
      aliasToken.ColorControlOutline = ColorUtils.AlphaColor(colorPrimaryToken.ColorPrimaryBg, colorNeutralToken.ColorBgContainer);
