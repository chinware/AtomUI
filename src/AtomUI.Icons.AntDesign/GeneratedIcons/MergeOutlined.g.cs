...
public class MergeOutlined : AntDesignIcon
{
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(172, 100, 680, 824);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1082251082251082, 0, 0, 1.1082251082251082, -55.411255411255411, -55.411255411255411);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Transform = new Matrix(1, 0, 0, -1, 172, 924)
        }
,         new PathDrawingInstruction()
        {
