...
public class JavaOutlined : AntDesignIcon
{
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(-56.79099999999994, -594.51600000000008, 1221.847, 1929.6969999999999);
    internal override Matrix GeneratedZoomMatrix => new Matrix(0.4569637436754701, 0, 0, 0.4569637436754701, 278.03456323815931, 278.03456323815931);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Transform = new Matrix(1, 0, 0, 1, 182, 64)
        }
    ];
