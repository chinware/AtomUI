...
public class DockerOutlined : AntDesignIcon
{
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(54.930999999999997, 202, 905.06899999999996, 630);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0566843021497951, 0, 0, 1.0566843021497951, -29.022362700695112, -29.022362700695112);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Transform = new Matrix(1, 0, 0, 1, 64, 202)
        }
    ];
