...
public class TikTokOutlined : AntDesignIcon
{
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(164.697, 112, 695.303, 802.32300000000009);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1256742777931068, 0, 0, 1.1256742777931068, -64.345230230070683, -64.345230230070683);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Transform = new Matrix(1, 0, 0, 1, 165, 112)
        }
    ];
