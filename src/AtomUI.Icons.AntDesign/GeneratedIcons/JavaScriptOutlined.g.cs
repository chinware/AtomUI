...
public class JavaScriptOutlined : AntDesignIcon
{
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(63, 160, 898, 705);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0655567117585849, 0, 0, 1.0655567117585849, -33.565036420395472, -33.565036420395472);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Transform = new Matrix(1, 0, 0, 1, 63, 160)
        }
    ];
