...
internal partial class zh_CN : LanguageProvider
{
    ...
    public const string ApiPropertyFormLayout = "控制表单及表单项的布局模式。";
    public const string ApiPropertyLabelColInfo = "水平布局中标签区域的栅格列尺寸。";
    public const string ApiPropertyWrapperColInfo = "水平布局中字段包裹区域的栅格列尺寸。";
    public const string ApiPropertyRequiredMark = "控制必填和可选标记的展示方式。";
    public const string ApiPropertyValidateTrigger = "表单项的默认校验触发时机。";
    public const string ApiPropertyIsValidateFeedbackEnabled = "为表单项显示校验反馈图标和状态。";
    public const string ApiPropertyInitialValues = "表单创建时应用的初始值。";
    public const string ApiPropertyValues = "表单收集到的当前字段值。";
    public const string ApiPropertyFormItemFieldName = "用于将表单项绑定到表单值的字段键。";
    public const string ApiPropertyFormItemValidators = "绑定到表单项的校验规则。";
    public const string ApiPropertyFormItemValidateTrigger = "覆盖单个表单项的校验触发时机。";
    public const string ApiPropertyFormItemHelp = "显示在表单项下方的校验或辅助文本。";
    public const string ApiEventSubmitted = "表单提交动作触发时抛出。";
    public const string ApiEventValidated = "表单校验完成后抛出。";
    ...
    public const string TokenNameLabelRequiredMarkColor = "必填标记颜色。";
    public const string TokenNameLabelColor = "表单标签文本颜色。";
    public const string TokenNameLabelFontSize = "表单标签字号。";
    public const string TokenNameLabelColonMargin = "标签冒号的水平外边距。";
    public const string TokenNameFormItemSpacing = "表单项之间的垂直间距。";
    public const string TokenNameInlineItemSpacing = "行内布局中表单项之间的间距。";
    public const string TokenNameVerticalLabelPadding = "垂直布局中标签下方内边距。";
    public const string TokenNameVerticalLabelMargin = "垂直布局中标签外边距。";
