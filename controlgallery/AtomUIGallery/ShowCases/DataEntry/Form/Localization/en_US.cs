...
internal partial class en_US : LanguageProvider
{
    ...
    public const string ApiPropertyFormLayout = "Controls the layout mode of the form and its items.";
    public const string ApiPropertyLabelColInfo = "Grid column sizing used by labels in horizontal layout.";
    public const string ApiPropertyWrapperColInfo = "Grid column sizing used by field wrappers in horizontal layout.";
    public const string ApiPropertyRequiredMark = "Controls how required and optional marks are displayed.";
    public const string ApiPropertyValidateTrigger = "Default validation trigger for form items.";
    public const string ApiPropertyIsValidateFeedbackEnabled = "Shows validation feedback icon and status for form items.";
    public const string ApiPropertyInitialValues = "Initial form values applied when the form is created.";
    public const string ApiPropertyValues = "Current field values collected by the form.";
    public const string ApiPropertyFormItemFieldName = "Field key used to bind a form item to form values.";
    public const string ApiPropertyFormItemValidators = "Validation rules attached to a form item.";
    public const string ApiPropertyFormItemValidateTrigger = "Overrides the validation trigger for a single form item.";
    public const string ApiPropertyFormItemHelp = "Extra validation or helper text displayed below a form item.";
    public const string ApiEventSubmitted = "Raised when the form submit action is invoked.";
    public const string ApiEventValidated = "Raised after form validation completes.";
    ...
    public const string TokenNameLabelRequiredMarkColor = "Color of the required mark.";
    public const string TokenNameLabelColor = "Text color used by form labels.";
    public const string TokenNameLabelFontSize = "Font size used by form labels.";
    public const string TokenNameLabelColonMargin = "Horizontal margin around the label colon.";
    public const string TokenNameFormItemSpacing = "Vertical spacing between form items.";
    public const string TokenNameInlineItemSpacing = "Spacing between form items in inline layout.";
    public const string TokenNameVerticalLabelPadding = "Padding below labels in vertical layout.";
    public const string TokenNameVerticalLabelMargin = "Margin around labels in vertical layout.";
