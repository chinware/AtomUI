...
internal partial class en_US : LanguageProvider
{
    ...
    public const string PageDescription = "ToggleSwitch is used for immediate on/off decisions. It supports disabled state, loading state, custom on/off content, icon content, two sizes, motion, and wave feedback.";
    ...
    public const string ApiPropertySizeType = "Controls middle or small switch size.";
