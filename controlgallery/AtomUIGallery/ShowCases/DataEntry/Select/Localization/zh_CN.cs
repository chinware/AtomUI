...
internal partial class zh_CN
{
    ...
    public const string BindingTitle = "双向绑定";
    public const string BindingDescription = "SelectedOption 和 SelectedOptions 默认与 ViewModel 双向同步，无需显式设置 Binding Mode=TwoWay。";
    ...
    public const string BindingSetSingleButton = "设为 Lucy";
    public const string BindingSetMultipleButton = "设为 Jack + Yiminghe";
    ...
    public const string PageSubtitle = "支持单选、多选、搜索和标签输入的选项选择。";
    public const string PageDescription = "Select 用于从选项列表中选择值，支持筛选、分组、异步加载、自定义渲染和多选行为。";
    ...
    public const string ApiPropertyMode = "选择模式，包括单选、多选和标签模式。";
    public const string ApiPropertyOptionsSource = "下拉列表中展示的选项数据。";
    public const string ApiPropertySelectedOption = "单选模式当前选项，默认支持双向绑定。";
    public const string ApiPropertySelectedOptions = "多选和标签模式当前选项集合，默认支持双向绑定。";
    public const string ApiPropertyDefaultValues = "初始选中的选项值。";
    ...
    public const string ApiPropertyMaxCount = "多选模式下最多可选的选项数量。";
    public const string ApiPropertyIsResponsiveTagMode = "根据可用宽度响应式折叠已选标签。";
    public const string ApiPropertyMaxTagCount = "折叠前最多显示的已选标签数量。";
    public const string ApiPropertyOptionsLoader = "下拉打开时异步加载选项。";
    ...
    public const string TokenNameMultipleItemBg = "多选模式下已选标签背景色。";
    public const string TokenNameMultipleItemHeight = "多选模式下已选标签默认高度。";
    public const string TokenNameMultipleItemHeightSM = "多选模式下小号已选标签高度。";
    public const string TokenNameMultipleItemHeightLG = "多选模式下大号已选标签高度。";
    public const string TokenNameMultipleSelectorBgDisabled = "禁用多选选择器背景色。";
    public const string TokenNameOptionSelectedColor = "选中选项文本颜色。";
    public const string TokenNameOptionSelectedBg = "选中选项背景色。";
    public const string TokenNameOptionActiveBg = "激活选项背景色。";
    public const string TokenNameOptionPadding = "选项行内边距。";
    public const string TokenNameOptionHeight = "选项行高度。";
    public const string TokenNamePopupContentPadding = "弹出层选项内容内边距。";
    ...
    public const string SizesDescription = "选择器输入区域默认高度为 32px。size 设置为 large 时高度为 40px，设置为 small 时高度为 24px。Custom 可配合本地尺寸属性自定义。";
