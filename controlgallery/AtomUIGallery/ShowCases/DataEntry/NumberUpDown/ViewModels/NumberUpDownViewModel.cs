...
public class NumberUpDownViewModel : ReactiveObject, IRoutableViewModel
{
    ...
    public void EnsureApiRows()
    {
        ...
        [
            ...
            new NumberUpDownApiRow("Mode", Lang(NumberUpDownShowCaseLangResourceKind.ApiPropertyMode), "NumericUpDownMode", "purple", "Input"),
    ...
    private static string FallbackLang(NumberUpDownShowCaseLangResourceKind kind)
    {
        return kind switch
        {
            ...
            NumberUpDownShowCaseLangResourceKind.ApiPropertyMode              => en_US.ApiPropertyMode,
