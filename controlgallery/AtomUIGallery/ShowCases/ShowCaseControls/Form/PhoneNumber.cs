                           ...
                           IInputControlStyleVariantAware
{
    ...
    public static readonly StyledProperty<string?> ValueProperty =
        AvaloniaProperty.Register<PhoneNumber, string?>(nameof(Value));
    
    public static readonly StyledProperty<InputControlStyleVariant> StyleVariantProperty =
        InputControlStyleVariantProperty.StyleVariantProperty.AddOwner<PhoneNumber>();
    ...
    static PhoneNumber()
    {
        ValueProperty.Changed.AddClassHandler<PhoneNumber>((number, args) => number.HandleValueChanged());
    }
