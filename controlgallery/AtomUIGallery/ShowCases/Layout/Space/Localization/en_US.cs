...
internal partial class en_US
{
    ...
    public const string ApiPropertySpaceItemSpacing = "Controls the spacing between items on the primary axis.";
    public const string ApiPropertySpaceLineSpacing = "Controls spacing between wrapped lines or vertical rows.";
    public const string ApiPropertySpaceOrientation = "Sets whether child controls flow horizontally or vertically.";
    public const string ApiPropertySpaceItemsAlignment = "Aligns children within each line on the cross axis.";
    public const string ApiPropertySpaceSizeType = "Uses predefined token spacing sizes or a custom spacing mode.";
    public const string ApiPropertySpaceItemWidth = "Applies a fixed width to each item when set.";
    public const string ApiPropertySpaceItemHeight = "Applies a fixed height to each item when set.";
    public const string ApiPropertySpaceSplitTemplate = "Creates separator content between adjacent items.";
    public const string ApiPropertyCompactSpaceOrientation = "Sets the compact group direction.";
    public const string ApiPropertyCompactSpaceSizeType = "Propagates size to compatible compact child controls.";
    public const string ApiPropertyCompactSpaceItemSize = "Attached property that controls the proportional or fixed size of one compact item.";
    ...
    public const string TokenStatusDefault = "Default";
    public const string TokenNameGapSmallSize = "Small spacing size.";
    public const string TokenNameGapMiddleSize = "Middle spacing size.";
    public const string TokenNameGapLargeSize = "Large spacing size.";
    public const string TokenNameAddonBg = "Compact add-on background color.";
    public const string TokenNameAddOnPadding = "Default compact add-on horizontal padding.";
    public const string TokenNameAddOnPaddingSM = "Small compact add-on horizontal padding.";
    public const string TokenNameAddOnPaddingLG = "Large compact add-on horizontal padding.";
