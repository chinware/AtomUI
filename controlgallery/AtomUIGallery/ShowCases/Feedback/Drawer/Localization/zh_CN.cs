...
internal partial class zh_CN
{
    ...
    public const string FormInDrawerTitle = "抽屉表单";
    public const string FormInDrawerDescription = "在抽屉中使用表单，适合不离开当前页面完成创建任务。";
    ...
    public const string P2ContentNewAccount = "新建账号";
    public const string P2ContentEdit = "编辑";
    public const string P2ContentUpload = "上传";
    public const string P2ContentDelete = "删除";
    public const string P2TitleCreateNewAccount = "创建一个新账号";
    public const string P2LabelTextName = "名称";
    public const string P2LabelTextUrl = "地址";
    public const string P2LabelTextOwner = "负责人";
    public const string P2LabelTextType = "类型";
    public const string P2LabelTextApprover = "审批人";
    public const string P2LabelTextDateTime = "日期时间";
    public const string P2LabelTextDescription = "描述";
    public const string P2PlaceholderTextPleaseEnterUserName = "请输入用户名";
    public const string P2PlaceholderTextPleaseEnterUrl = "请输入地址";
    public const string P2PlaceholderTextPleaseSelectOwner = "请选择负责人";
    public const string P2PlaceholderTextPleaseChooseType = "请选择类型";
    public const string P2PlaceholderTextPleaseChooseApprover = "请选择审批人";
    public const string P2PlaceholderTextStartDate = "开始日期";
    public const string P2SecondaryPlaceholderTextEndDate = "结束日期";
    public const string P2PlaceholderTextPleaseEnterUrlDescription = "请输入地址描述";
    public const string P2HeaderXiaoxiaoFu = "付小小";
    public const string P2HeaderMaomaoZhou = "周毛毛";
    public const string P2HeaderPrivate = "私有";
    public const string P2HeaderPublic = "公开";
    public const string P2HeaderJackMa = "马杰克";
    public const string P2HeaderTomLiu = "刘汤姆";
