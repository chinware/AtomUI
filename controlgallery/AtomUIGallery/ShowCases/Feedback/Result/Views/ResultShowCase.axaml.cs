...
public partial class ResultShowCase : GalleryReactiveUserControl<ResultViewModel>
{
    ...
    private static Control CreateScenarioContent(string scenario)
    {
        ...
        {
            ApiScenario         => new ResultApiDataGrid(),
            DesignTokenScenario => new ResultDesignTokenDataGrid(),
            _                   => throw new InvalidOperationException($"Unknown Result scenario: {scenario}")
        };
    }
}
