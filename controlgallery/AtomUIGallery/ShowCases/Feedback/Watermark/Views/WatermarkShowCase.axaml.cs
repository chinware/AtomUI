...
public partial class WatermarkShowCase : GalleryReactiveUserControl<WatermarkViewModel>
{
    ...
    private static Control CreateScenarioContent(string scenario)
    {
        ...
        {
            ApiScenario         => new WatermarkApiDataGrid(),
            DesignTokenScenario => new WatermarkDesignTokenDataGrid(),
            _                   => throw new InvalidOperationException($"Unknown Watermark scenario: {scenario}")
        };
    }
}
