...
internal partial class zh_TW
{
    ...
    public const string PageSubtitle = "醒目的上下文反饋信息。";
    public const string PageDescription = "Alert 用於展示重要狀態信息和可選操作，不打斷當前工作流。";
    ...
    public const string ApiPropertyType = "設置反饋類型和對應的狀態色。";
    public const string ApiPropertyMessage = "提示框中展示的主要文本內容。";
    public const string ApiPropertyDescription = "展示在主要文本下方的可選輔助說明。";
    public const string ApiPropertyIsShowIcon = "顯示與提示類型匹配的狀態圖標。";
    public const string ApiPropertyIsMessageMarqueeEnabled = "長單行內容可使用跑馬燈方式展示。";
    public const string ApiPropertyIsClosable = "顯示關閉按鈕並啟用關閉請求。";
    public const string ApiPropertyCloseIcon = "關閉按鈕使用的自定義圖標。";
    public const string ApiPropertyExtraAction = "展示在提示框右側的可選操作內容。";
    public const string ApiEventCloseRequest = "用戶點擊關閉按鈕時觸發。";
    ...
    public const string TokenNameDefaultPadding = "不含描述信息的緊湊提示內間距。";
    public const string TokenNameWithDescriptionPadding = "包含描述信息時的提示內間距。";
    public const string TokenNameMessageWithDescriptionMargin = "包含描述信息時消息文本下方的外間距。";
    public const string TokenNameIconDefaultMargin = "緊湊提示中的圖標外間距。";
    public const string TokenNameIconWithDescriptionMargin = "包含描述信息時的圖標外間距。";
    public const string TokenNameIconSize = "緊湊提示中的狀態圖標尺寸。";
    public const string TokenNameWithDescriptionIconSize = "包含描述信息時的狀態圖標尺寸。";
    public const string TokenNameCloseIconSize = "關閉按鈕圖標尺寸。";
    public const string TokenNameExtraElementMargin = "關閉按鈕和額外操作元素前的外間距。";
    public const string TokenNameDescriptionLabelMargin = "描述文本標籤上方的外間距。";
