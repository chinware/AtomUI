...
internal partial class en_US : LanguageProvider
{
    ...
    public const string PageSubtitle = "Prominent contextual feedback message.";
    public const string PageDescription = "Alert displays important status information and optional actions without interrupting the current workflow.";
    ...
    public const string ApiPropertyType = "Sets the visual feedback type and status color.";
    public const string ApiPropertyMessage = "Primary text content displayed in the alert.";
    public const string ApiPropertyDescription = "Optional supporting text shown below the message.";
    public const string ApiPropertyIsShowIcon = "Shows the status icon that matches the alert type.";
    public const string ApiPropertyIsMessageMarqueeEnabled = "Renders the message with marquee scrolling for long single-line content.";
    public const string ApiPropertyIsClosable = "Shows a close button and enables close requests.";
    public const string ApiPropertyCloseIcon = "Custom icon used by the close button.";
    public const string ApiPropertyExtraAction = "Optional action content displayed at the right side of the alert.";
    public const string ApiEventCloseRequest = "Raised when the user clicks the close button.";
    ...
    public const string TokenNameDefaultPadding = "Padding used by a compact alert without description text.";
    public const string TokenNameWithDescriptionPadding = "Padding used when the alert contains a description.";
    public const string TokenNameMessageWithDescriptionMargin = "Margin below the message when description text is present.";
    public const string TokenNameIconDefaultMargin = "Icon margin for compact alerts.";
    public const string TokenNameIconWithDescriptionMargin = "Icon margin for alerts with description text.";
    public const string TokenNameIconSize = "Status icon size for compact alerts.";
    public const string TokenNameWithDescriptionIconSize = "Status icon size for alerts with description text.";
    public const string TokenNameCloseIconSize = "Close button icon size.";
    public const string TokenNameExtraElementMargin = "Margin before close and extra action elements.";
    public const string TokenNameDescriptionLabelMargin = "Margin above the description label.";
