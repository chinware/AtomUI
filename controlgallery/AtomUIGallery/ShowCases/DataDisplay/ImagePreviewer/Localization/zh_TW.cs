...
internal partial class zh_TW : LanguageProvider
{
    ...
    public const string ApiPropertyItemsSource = "ImagePreviewer 和 ImageGroupPreviewer 使用的圖片源 URI 列表。";
    public const string ApiPropertyFallbackImageSrc = "配置圖片載入失敗時顯示的容錯圖片。";
    ...
    public const string ApiPropertyCoverImageSrc = "ImagePreviewer 的自定義封面圖片源。";
