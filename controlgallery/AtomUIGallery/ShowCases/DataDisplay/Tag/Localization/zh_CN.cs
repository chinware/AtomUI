...
internal partial class zh_CN
{
    ...
    public const string CheckableTagTitle = "可选择标签";
    public const string CheckableTagDescription = "CheckableTag 提供类似 Checkbox 的切换效果，CheckableTagGroup 可在同组选项上进行单选或多选。";
    ...
    public const string VariantTitle = "形态变体";
    public const string VariantDescription = "Filled、Solid 和 Outlined 三种形态可以与颜色独立组合。";
    ...
    public const string P2LabelCheckable = "可选择";
    public const string P2LabelSingle = "单选";
    public const string P2LabelMultiple = "多选";
    ...
    public const string P2TextPresetsFilled = "预设（filled）";
    public const string P2TextPresetsSolid = "预设（solid）";
    public const string P2TextPresetsOutlined = "预设（outlined）";
    public const string P2TextCustomFilled = "自定义（filled）";
    public const string P2TextCustomSolid = "自定义（solid）";
    public const string P2TextCustomOutlined = "自定义（outlined）";
    public const string P2TextStatusFilled = "状态（filled）";
    public const string P2TextStatusSolid = "状态（solid）";
    public const string P2TextStatusOutlined = "状态（outlined）";
    ...
    public const string P2TextVariants = "默认颜色";
    public const string P2TextPresetVariant = "预设颜色";
    public const string P2TextStatusVariant = "状态颜色";
    public const string P2TextCustomVariant = "自定义颜色";
    public const string P2ContentFilled = "浅色填充";
    public const string P2ContentSolid = "实色填充";
    ...
    public const string PageDescription =
        "Tag 用于展示短标签，支持预设、状态和自定义颜色，并可组合浅色填充、实色填充和描边形态。";
