...
internal partial class en_US
{
    ...
    public const string DynamicModeTitle = "Dynamic mode";
    public const string DynamicModeDescription = "Switch between Start, End, and Alternate placement at runtime.";
    public const string HorizontalTitle = "Horizontal";
    public const string HorizontalDescription = "Horizontal timelines support Start, End, and Alternate placement.";
