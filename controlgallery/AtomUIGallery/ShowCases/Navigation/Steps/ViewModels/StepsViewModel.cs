...
public class StepsViewModel : ReactiveObject, IRoutableViewModel
{
    ...
    public void EnsureApiRows()
    {
        ...
        [
            ...
            new StepsApiRow("Steps.Offset", Lang(StepsShowCaseLangResourceKind.ApiPropertyOffset), "int", "cyan", "0"),
            new StepsApiRow("Steps.HorizontalContentAlignment", Lang(StepsShowCaseLangResourceKind.ApiPropertyHorizontalContentAlignment), "HorizontalAlignment", "blue", "Center"),
    ...
    public void EnsureDesignTokenRows()
    {
        ...
        [
            ...
            new StepsDesignTokenRow("SubHeaderMargin", Lang(StepsShowCaseLangResourceKind.TokenNameSubHeaderMargin), Lang(StepsShowCaseLangResourceKind.TokenScopeComponent), "cyan", Lang(StepsShowCaseLangResourceKind.TokenStatusStable), "success"),
    ...
    private static string FallbackLang(StepsShowCaseLangResourceKind kind)
    {
        return kind switch
        {
            ...
            StepsShowCaseLangResourceKind.ApiPropertyOffset                     => en_US.ApiPropertyOffset,
            StepsShowCaseLangResourceKind.ApiPropertyHorizontalContentAlignment => en_US.ApiPropertyHorizontalContentAlignment,
            ...
            StepsShowCaseLangResourceKind.TokenNameSubHeaderMargin              => en_US.TokenNameSubHeaderMargin,
