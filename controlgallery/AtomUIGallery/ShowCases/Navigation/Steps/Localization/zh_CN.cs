...
internal partial class zh_CN
{
    ...
    public const string InlineStyleCombinationTitle = "内联样式组合";
    public const string InlineStyleCombinationDescription = "内联步骤条修改样式，通过 offset 进行对齐。";
    ...
    public const string P2HeaderStepN5 = "步骤 5";
    public const string P2ContentThisIsStepN1 = "这是步骤 1";
    public const string P2ContentThisIsStepN2 = "这是步骤 2";
    public const string P2ContentThisIsStepN3 = "这是步骤 3";
    public const string P2ContentThisIsStepN4 = "这是步骤 4";
    public const string P2ContentThisIsStepN5 = "这是步骤 5";
    ...
    public const string P2SubHeaderSubTitle = "子标题";
