...
internal partial class zh_CN
{
    ...
    public const string ApiPropertyType = "选择完整的 Default、Dot、OutlineDot、Navigation 或 Inline 视觉类型。";
    ...
    public const string ApiPropertyOffset = "内联步骤前方保留的空步骤单元数量；其他类型忽略该属性。";
    public const string ApiPropertyHorizontalContentAlignment = "垂直 Navigation 步骤项的水平对齐方式。";
    ...
    public const string TokenNameSubHeaderMargin = "步骤辅助标题使用的左侧外间距。";
