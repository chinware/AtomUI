...
internal partial class zh_CN
{
    ...
    public const string ApiPropertyCurrentStep = "设置或绑定当前激活步骤索引。默认使用 TwoWay 绑定。";
    ...
    public const string SwitchStepDescription = "配合内容、按钮和可点击步骤，通过 CurrentStep 绑定展示流程进度。";
