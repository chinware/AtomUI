...
public class ComboBoxViewModel : ReactiveObject, IRoutableViewModel
{
    ...
    public void EnsureApiRows()
    {
        ...
        [
            ...
            new ComboBoxApiRow("IsEditable", Lang(ComboBoxShowCaseLangResourceKind.ApiPropertyIsEditable), "bool", "purple", "false"),
            new ComboBoxApiRow("Text", Lang(ComboBoxShowCaseLangResourceKind.ApiPropertyText), "string?", "cyan", "null"),
            new ComboBoxApiRow("IsFilterEnabled", Lang(ComboBoxShowCaseLangResourceKind.ApiPropertyIsFilterEnabled), "bool", "purple", "false"),
            new ComboBoxApiRow("IsShowOverflowTip", Lang(ComboBoxShowCaseLangResourceKind.ApiPropertyIsShowOverflowTip), "bool", "purple", "true"),
            new ComboBoxApiRow("OverflowTipDelay", Lang(ComboBoxShowCaseLangResourceKind.ApiPropertyOverflowTipDelay), "int", "cyan", "1200"),
            new ComboBoxApiRow("OverflowTipPlacement", Lang(ComboBoxShowCaseLangResourceKind.ApiPropertyOverflowTipPlacement), "PlacementMode", "purple", "TopEdgeAlignedLeft"),
            new ComboBoxApiRow("Filter", Lang(ComboBoxShowCaseLangResourceKind.ApiPropertyFilter), "IValueFilter?", "cyan", "Contains"),
            new ComboBoxApiRow("FilterValue", Lang(ComboBoxShowCaseLangResourceKind.ApiPropertyFilterValue), "object?", "cyan", "null"),
            new ComboBoxApiRow("FilterValueSelector", Lang(ComboBoxShowCaseLangResourceKind.ApiPropertyFilterValueSelector), "DefaultFilterValueSelector?", "cyan", "null"),
    ...
    private static string FallbackLang(ComboBoxShowCaseLangResourceKind kind)
    {
        return kind switch
        {
            ...
            ComboBoxShowCaseLangResourceKind.ApiPropertyIsFilterEnabled          => en_US.ApiPropertyIsFilterEnabled,
            ComboBoxShowCaseLangResourceKind.ApiPropertyIsShowOverflowTip        => en_US.ApiPropertyIsShowOverflowTip,
            ComboBoxShowCaseLangResourceKind.ApiPropertyOverflowTipDelay         => en_US.ApiPropertyOverflowTipDelay,
            ComboBoxShowCaseLangResourceKind.ApiPropertyOverflowTipPlacement     => en_US.ApiPropertyOverflowTipPlacement,
            ComboBoxShowCaseLangResourceKind.ApiPropertyFilter                   => en_US.ApiPropertyFilter,
            ComboBoxShowCaseLangResourceKind.ApiPropertyFilterValue              => en_US.ApiPropertyFilterValue,
            ComboBoxShowCaseLangResourceKind.ApiPropertyFilterValueSelector      => en_US.ApiPropertyFilterValueSelector,
