...
internal partial class en_US
{
    ...
    public const string IncubationTitle = "AtomUI OSS joins the TLAIC open-source incubation program";
    public const string IncubationDescription = "Supported by TLAIC, AtomUI OSS continues to advance cross-platform desktop software, open-source community operations, and the developer ecosystem.";
    public const string IncubationPointOpenSource = "Open-source incubation";
    public const string IncubationPointEcosystem = "Ecosystem building";
    public const string IncubationPointLicense = "Open licensing";
