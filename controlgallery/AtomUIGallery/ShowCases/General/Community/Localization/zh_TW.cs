...
internal partial class zh_TW
{
    ...
    public const string IncubationTitle = "AtomUI OSS 納入通明湖中心開源孵化體系";
    public const string IncubationDescription = "獲得通明湖中心開源孵化體系支持，持續推進跨平台桌面軟件、開源社區運營與開發者生態建設。";
    public const string IncubationPointOpenSource = "開源孵化";
    public const string IncubationPointEcosystem = "生態共建";
    public const string IncubationPointLicense = "開放許可";
