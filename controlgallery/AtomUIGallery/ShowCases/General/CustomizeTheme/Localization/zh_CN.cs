...
internal partial class zh_CN
{
    ...
    public const string RuntimeTokenUpdatesDescription = "ThemeConfigProvider 会监听 TokenSetter 变化并重新发布一个局部 Snapshot，不会追加额外资源 Provider 层。";
    ...
    public const string P2ContentIsolationText = "组件内容";
