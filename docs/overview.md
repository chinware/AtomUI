...
- [跨模块系统](architecture/systems/overview.md)：主题、字体、本地化、统一图片加载、Control 基础设施和渲染系统的统一入口。
...
docs/
|-- overview.md
|-- architecture/   # 跨模块当前架构与带统一状态声明的预实现架构
|-- modules/        # 单个源码项目或发布包
...
- [统一图片加载架构](architecture/systems/image-loading/overview.md)
