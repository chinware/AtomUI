...
| P1.10 | Implemented | Tag | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Tag` | `TagShowCase.axaml`; `TagApiDataGrid.axaml`; `TagDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery Desktop build passed; awaiting user acceptance. |
