...
| P1.3 | Implemented | Calendar | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Calendar` | `CalendarShowCase.axaml`; `CalendarApiDataGrid.axaml`; `CalendarDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery Desktop build passed; awaiting user acceptance. |
...
| P1.6 | Not Started | GroupBox | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/GroupBox` | `GroupBoxShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.7 | Not Started | QRCode | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/QRCode` | `QRCodeShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.8 | Not Started | Segmented | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Segmented` | `SegmentedShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.9 | Not Started | Statistic | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Statistic` | `StatisticShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.10 | Not Started | Tag | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Tag` | `TagShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.11 | Not Started | Timeline | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Timeline` | `TimelineShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.12 | Not Started | Tooltip | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Tooltip` | `TooltipShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.13 | Not Started | Alert | `controlgallery/AtomUIGallery/ShowCases/Feedback/Alert` | `AlertShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.14 | Not Started | Result | `controlgallery/AtomUIGallery/ShowCases/Feedback/Result` | `ResultShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.15 | Not Started | Skeleton | `controlgallery/AtomUIGallery/ShowCases/Feedback/Skeleton` | `SkeletonShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.16 | Not Started | Spin | `controlgallery/AtomUIGallery/ShowCases/Feedback/Spin` | `SpinShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.17 | Not Started | Watermark | `controlgallery/AtomUIGallery/ShowCases/Feedback/Watermark` | `WatermarkShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.18 | Not Started | Separator | `controlgallery/AtomUIGallery/ShowCases/General/Separator` | `SeparatorShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.19 | Not Started | Breadcrumb | `controlgallery/AtomUIGallery/ShowCases/Navigation/Breadcrumb` | `BreadcrumbShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.20 | Not Started | Pagination | `controlgallery/AtomUIGallery/ShowCases/Navigation/Pagination` | `PaginationShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.21 | Not Started | Rate | `controlgallery/AtomUIGallery/ShowCases/DataEntry/Rate` | `RateShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.22 | Not Started | Slider | `controlgallery/AtomUIGallery/ShowCases/DataEntry/Slider` | `SliderShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.23 | Not Started | ToggleSwitch | `controlgallery/AtomUIGallery/ShowCases/DataEntry/ToggleSwitch` | `ToggleSwitchShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
| P1.24 | Not Started | Splitter | `controlgallery/AtomUIGallery/ShowCases/Layout/Splitter` | `SplitterShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |

### P2 Medium Controls

| ID | Status | ShowCase | Component Folder | Current Views | Verification |
|---|---|---|---|---|---|
| P2.1 | Not Started | Card | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Card` | `CardShowCase.axaml`; `CardBasicShowCase.axaml`; `CardAdvancedShowCase.axaml`; `CardLayoutShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
