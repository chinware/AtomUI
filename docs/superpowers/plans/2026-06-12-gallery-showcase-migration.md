...
| P1.8 | Implemented | Segmented | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Segmented` | `SegmentedShowCase.axaml`; `SegmentedApiDataGrid.axaml`; `SegmentedDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery Desktop build passed; awaiting user acceptance. |
