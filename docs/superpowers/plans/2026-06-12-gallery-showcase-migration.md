...
| P1.9 | In Progress | Statistic | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Statistic` | `StatisticShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
