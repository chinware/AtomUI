...
| P1.6 | In Progress | GroupBox | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/GroupBox` | `GroupBoxShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
