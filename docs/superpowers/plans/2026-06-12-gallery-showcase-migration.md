...
| P1.8 | In Progress | Segmented | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Segmented` | `SegmentedShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
