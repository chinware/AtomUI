...
| P1.22 | Implemented | Slider | `controlgallery/AtomUIGallery/ShowCases/DataEntry/Slider` | `SliderShowCase.axaml`; `SliderApiDataGrid.axaml`; `SliderDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery tests passed; Gallery Desktop build passed. |
