...
| P3.11 | Implemented | Menu | `controlgallery/AtomUIGallery/ShowCases/Navigation/Menu` | `MenuShowCase.axaml`; `MenuApiDataGrid.axaml`; `MenuDesignTokenDataGrid.axaml`; old Basic/Features/ItemsSource/Context/Navigation sub-showcase files merged into root and removed | Structure + snapshot + lazy tabs passed; Gallery tests passed; Gallery Desktop build passed; desktop controls tests passed. Awaiting user acceptance. |
