...
| P1.5 | Implemented | Empty | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Empty` | `EmptyShowCase.axaml`; `EmptyApiDataGrid.axaml`; `EmptyDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery Desktop build passed; awaiting user acceptance. |
