...
| P2.12 | Implemented | Mentions | `controlgallery/AtomUIGallery/ShowCases/DataEntry/Mentions` | `MentionsShowCase.axaml`; `MentionsApiDataGrid.axaml`; `MentionsDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery tests passed; Gallery Desktop build passed; `git diff --check` passed. |
