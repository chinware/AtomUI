...
| P2.6 | Implemented | InfoFlyout | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/InfoFlyout` | `InfoFlyoutShowCase.axaml`; `InfoFlyoutApiDataGrid.axaml`; `InfoFlyoutDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; `AtomUIGallery.Tests` passed; Gallery Desktop build passed; `git diff --check` passed. |
