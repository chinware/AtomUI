...
| P2.2 | Implemented | Carousel | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Carousel` | `CarouselShowCase.axaml`; `CarouselApiDataGrid.axaml`; `CarouselDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; `AtomUIGallery.Tests` passed; Gallery Desktop build passed; `git diff --check` passed. |
