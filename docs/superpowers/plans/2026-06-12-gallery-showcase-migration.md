...
| P2.18 | In Progress | FloatButton | `controlgallery/AtomUIGallery/ShowCases/General/FloatButton` | `FloatButtonShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
