...
| P1.24 | Implemented | Splitter | `controlgallery/AtomUIGallery/ShowCases/Layout/Splitter` | `SplitterShowCase.axaml`; `SplitterApiDataGrid.axaml`; `SplitterDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery tests passed; Gallery Desktop build passed. |
