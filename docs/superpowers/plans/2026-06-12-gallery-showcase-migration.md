...
| P1.6 | Implemented | GroupBox | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/GroupBox` | `GroupBoxShowCase.axaml`; `GroupBoxApiDataGrid.axaml`; `GroupBoxDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery Desktop build passed; awaiting user acceptance. |
