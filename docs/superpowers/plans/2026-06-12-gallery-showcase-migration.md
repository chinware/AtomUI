...
| P1.11 | In Progress | Timeline | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Timeline` | `TimelineShowCase.axaml` | Structure + snapshot + lazy tabs + Gallery build. |
