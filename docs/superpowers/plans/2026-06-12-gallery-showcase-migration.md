...
| P1.11 | Implemented | Timeline | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/Timeline` | `TimelineShowCase.axaml`; `TimelineApiDataGrid.axaml`; `TimelineDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery Desktop build passed; awaiting user acceptance. |
