...
| P1.18 | Implemented | Separator | `controlgallery/AtomUIGallery/ShowCases/General/Separator` | `SeparatorShowCase.axaml`; `SeparatorApiDataGrid.axaml`; `SeparatorDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery tests passed; Gallery Desktop build passed. |
