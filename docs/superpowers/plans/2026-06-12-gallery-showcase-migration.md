...
| P1.7 | Implemented | QRCode | `controlgallery/AtomUIGallery/ShowCases/DataDisplay/QRCode` | `QRCodeShowCase.axaml`; `QRCodeApiDataGrid.axaml`; `QRCodeDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery Desktop build passed; awaiting user acceptance. |
