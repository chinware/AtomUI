...
| P3.14 | Implemented | Message | `controlgallery/AtomUIGallery/ShowCases/Feedback/Message` | `MessageShowCase.axaml`; `MessageApiDataGrid.axaml`; `MessageDesignTokenDataGrid.axaml` | Structure + snapshot + lazy tabs passed; Gallery tests passed; Gallery Desktop build passed; desktop controls tests passed; `git diff --check` passed. |
