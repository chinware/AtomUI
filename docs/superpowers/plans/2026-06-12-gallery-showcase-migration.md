...
| P3.12 | Implemented | Steps | `controlgallery/AtomUIGallery/ShowCases/Navigation/Steps` | `StepsShowCase.axaml`; `StepsApiDataGrid.axaml`; `StepsDesignTokenDataGrid.axaml`; old Basic/Interactive/Vertical/DotClickable/Navigation/Progress/Inline sub-showcase files merged into root and removed | Structure + snapshot + lazy tabs passed; Gallery tests passed; Gallery Desktop build passed; desktop controls tests passed. Awaiting user acceptance. |
