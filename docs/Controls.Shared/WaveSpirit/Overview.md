...
> 本文档描述 AtomUI 波浪动画系统（WaveSpirit）的设计原理、实现机制及开发者使用指南。WaveSpirit 是 Ant Design 5.0 中按钮、复选框、单选按钮等控件在点击时产生的涟漪/波纹扩散效果的忠实 C# 实现。
...
1. **对齐 Ant Design 5.0**：忠实复现 Ant Design 的 Wave 效果，包括圆角矩形波纹、圆形波纹和药丸形波纹三种形态。
