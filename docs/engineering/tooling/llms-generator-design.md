...
```text
commercial/AtomUI.Charts/docs/AI/generated/llms.config.json
```
...
```text
commercial/<project>/docs/AI/generated/llms.config.json
...
```text
commercial/<project>/docs/AI/generated/llms/
```
