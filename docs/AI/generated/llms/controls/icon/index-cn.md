...
- `controlgallery/AtomUIGallery/ShowCases/General/Icon/Views/IconShowCase.axaml`
...
- 源设计文档：`docs/controls/desktop/general/icon/overview.md`
- 实现文档：`docs/controls/desktop/general/icon/implementation.md`
- Token 文档：`docs/controls/desktop/general/icon/token.md`
- 变更记录：`docs/controls/desktop/general/icon/changelog.md`
- 语义结构：`./semantic-cn.md`
