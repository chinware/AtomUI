...
来源：`controlgallery/AtomUIGallery/ShowCases/DataDisplay/InfoFlyout/Views/InfoFlyoutShowCase.axaml:78`
...
来源：`controlgallery/AtomUIGallery/ShowCases/DataDisplay/InfoFlyout/Views/InfoFlyoutShowCase.axaml:98`
...
SourceKey：`infoflyout-semantic-part`
...
<StackPanel Orientation="Horizontal" Spacing="16">
    <StackPanel.Styles>
        ...
        <Style Selector="atom|FlyoutHost.semantic-styles-function-demo">
            <atom:FlyoutHostPopupRootStyle x:SetterTargetType="atom:FlyoutPresenter">
    ...
    <atom:FlyoutHost Classes="semantic-styles-object-demo"
                     Trigger="Hover"
    ...
    <atom:FlyoutHost Classes="semantic-styles-function-demo"
                     Trigger="Hover"
                     ShouldUseOverlayPopup="False"
                     IsArrowVisible="False"
                     Placement="Top">
...
- 源设计文档：`docs/controls/desktop/data-display/info-flyout/overview.md`
- 实现文档：`docs/controls/desktop/data-display/info-flyout/implementation.md`
- Semantic Part 文档：`docs/controls/desktop/data-display/info-flyout/semantic-part.md`
- Token 文档：`docs/controls/desktop/data-display/info-flyout/token.md`
- 变更记录：`docs/controls/desktop/data-display/info-flyout/changelog.md`
- 语义结构：`./semantic-cn.md`
