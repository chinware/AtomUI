...
来源：`controlgallery/AtomUIGallery/ShowCases/DataDisplay/Tour/Views/TourShowCase.axaml:213`
...
<StackPanel Orientation="Vertical" Spacing="10">
    ...
    <atom:Tour IsOpen="{Binding PlacementTourOpened, Mode=TwoWay}" IsShowMask="True">
        <atom:TourStep Title="居中"
                       Description="显示在屏幕中央。" />
        <atom:TourStep Title="右侧"
                       Description="位于目标右侧。"
                       Placement="Right"
                       Target="{Binding ElementName=PlacementBeginTour}" />
        <atom:TourStep Title="顶部"
                       Description="位于目标上方。"
                       Placement="Top"
                       Target="{Binding ElementName=PlacementBeginTour}" />
        <atom:TourStep Title="左侧"
                       Description="位于目标左侧。"
                       Placement="Left"
                       Target="{Binding ElementName=PlacementBeginTour}" />
    </atom:Tour>
