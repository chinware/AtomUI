...
来源：`controlgallery/AtomUIGallery/ShowCases/DataEntry/Slider/Views/SliderShowCase.axaml:139`
...
来源：`controlgallery/AtomUIGallery/ShowCases/DataEntry/Slider/Views/SliderShowCase.axaml:179`
...
来源：`controlgallery/AtomUIGallery/ShowCases/DataEntry/Slider/Views/SliderShowCase.axaml:198`
...
来源：`controlgallery/AtomUIGallery/ShowCases/DataEntry/Slider/Views/SliderShowCase.axaml:245`

Gallery key：`ExamplesContent` / item `3`

```axaml
<StackPanel Orientation="Vertical" Spacing="20">
    <atom:TextBlock FontWeight="Bold" Text="included=true" />
    <atom:Slider
        Name="Slider4"
        Marks="{Binding SliderMarks}"
        Maximum="100"
    ...
    <atom:TextBlock FontWeight="Bold" Text="included=false" />
    <atom:Slider
        Name="Slider6"
        Marks="{Binding SliderMarks}"
        Maximum="100"
