...
- Gallery
  ...
  - Add the "Customize semantic structure styles" example (aligned with the upstream semantic styling demo): object-style and variant-conditioned TreeSelect part styles covering prefix / suffix / popup root.
- Tests
