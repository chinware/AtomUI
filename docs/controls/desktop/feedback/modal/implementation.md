...
- `OverlayDialogPresenterTests`: mask ownership、modal/modeless 输入、栈顶路由、跨平台 capability-driven drawn host、popup/scope fallback、完整 mask bounds、平台 body bounds、尺寸、拖动、resize、maximize/restore 和 motion。
