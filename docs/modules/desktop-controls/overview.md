...
- 向 DataGrid、ColorPicker、Extras、Labs、性能工具开放内部成员。
...
DataGrid、ColorPicker、Extras 和 Labs 虽然属于桌面控件体系，但它们是独立包，内部架构分别放在：
...
- [../desktop-controls-labs/overview.md](../desktop-controls-labs/overview.md)
