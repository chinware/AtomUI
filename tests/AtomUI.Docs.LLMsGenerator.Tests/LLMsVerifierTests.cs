...
public class LLMsVerifierTests
{
    ...
    public void GeneratedContentVerifierRejectsStalePathsPlaceholdersAndForbiddenNames()
    {
        ...
        var diagnostics = LLMsVerifier.ValidateGeneratedContent("docs/generated/llms/controls/button/index-cn.md", content);
    ...
    public void GeneratedOutputVerifierRejectsStaleFilesOnDisk()
    {
        ...
        var expected = new GeneratedLLMsFile("docs/generated/llms/llms.txt", "# Index\n\n" + LLMsWriterConstants.GeneratedMarker + "\n");
        var stalePath = Path.Combine(directory.FullName, "docs/generated/llms/controls/stale/index-cn.md");
