...
public class BrowserGalleryConventionsTests
{
    ...
    public void Browser_Gallery_Uses_Desktop_Workspace_Navigation_And_Routing()
    {
        ...
        source.ShouldContain("new CaseNavigationViewModel(this)");
        source.ShouldContain("new CaseNavigation");
        source.ShouldContain("Router          = Router");
        source.ShouldContain("ViewModel = _caseNavigationViewModel");
        source.ShouldContain("new ColumnDefinitions(\"280,*\")");
        source.ShouldContain("ColorBgLayout");
