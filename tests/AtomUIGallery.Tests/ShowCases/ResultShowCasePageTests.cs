...
{
    [Fact]
    public void Result_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("ResultShowCaseLangResource ScenarioApi");
        source.ShouldContain("ResultShowCaseLangResource ScenarioDesignToken");
    ...
    [Fact]
    public void Result_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        var pageSource       = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Feedback/Result/Views/ResultShowCase.axaml");
        var codeBehindSource = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Feedback/Result/Views/ResultShowCase.axaml.cs");
        var apiSource        = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Feedback/Result/Views/ResultApiDataGrid.axaml");
        var apiCodeSource    = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Feedback/Result/Views/ResultApiDataGrid.axaml.cs");
        var tokenSource      = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Feedback/Result/Views/ResultDesignTokenDataGrid.axaml");
        var tokenCodeSource  = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Feedback/Result/Views/ResultDesignTokenDataGrid.axaml.cs");
        ...
        apiSource.ShouldContain("x:DataType=\"viewModels:ResultApiRow\"");
        ...
        apiSource.ShouldContain("ResultShowCaseLangResource ApiColumnProperty");
        apiSource.ShouldContain("ResultShowCaseLangResource ApiColumnDescription");
        apiSource.ShouldContain("ResultShowCaseLangResource ApiColumnType");
        apiSource.ShouldContain("ResultShowCaseLangResource ApiColumnDefault");
        ...
        tokenSource.ShouldContain("x:DataType=\"viewModels:ResultDesignTokenRow\"");
        ...
        tokenSource.ShouldContain("ResultShowCaseLangResource TokenColumnToken");
        tokenSource.ShouldContain("ResultShowCaseLangResource TokenColumnDescription");
        tokenSource.ShouldContain("ResultShowCaseLangResource TokenColumnScope");
        tokenSource.ShouldContain("ResultShowCaseLangResource TokenColumnStatus");
    ...
    [Fact]
    public void Result_ShowCase_Localization_Includes_Page_And_Api_Copy()
    {
        var en   = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Feedback/Result/Localization/en_US.cs");
        var zhCn = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Feedback/Result/Localization/zh_CN.cs");
        var zhTw = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Feedback/Result/Localization/zh_TW.cs");
        ...
        foreach (var source in new[] { en, zhCn, zhTw })
        {
            ...
            source.ShouldContain("ApiPropertySubHeader");
            source.ShouldContain("ApiPropertyExtra");
            source.ShouldContain("TokenNameHeaderFontSize");
            source.ShouldContain("TokenNameSubHeaderFontSize");
