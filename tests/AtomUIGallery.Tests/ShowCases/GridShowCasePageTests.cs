...
public class GridShowCasePageTests
{
    ...
    public void Grid_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldNotContain("GridShowCaseLangResource ScenarioExamples");
        source.ShouldNotContain("GridShowCaseLangResource ScenarioApi");
        source.ShouldNotContain("GridShowCaseLangResource ScenarioDesignToken");
