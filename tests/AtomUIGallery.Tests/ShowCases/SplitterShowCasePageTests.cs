...
public class SplitterShowCasePageTests
{
    ...
    public void Splitter_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("SplitterShowCaseLangResource InfoNamespaceLabel");
        source.ShouldContain("SplitterShowCaseLangResource InfoPackageLabel");
        source.ShouldContain("SplitterShowCaseLangResource InfoBaseClassLabel");
        ...
        source.ShouldContain("Text=\"{gallery:SplitterShowCaseLangResource PageDescription}\"");
