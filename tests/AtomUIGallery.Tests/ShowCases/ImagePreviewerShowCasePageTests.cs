...
public class ImagePreviewerShowCasePageTests
{
    ...
    public void ImagePreviewer_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("ImagePreviewerShowCaseLangResource ScenarioApi");
        source.ShouldContain("ImagePreviewerShowCaseLangResource ScenarioDesignToken");
    ...
    public void ImagePreviewer_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        ...
        codeBehindSource.ShouldContain("new ImagePreviewerApiDataGrid()");
        codeBehindSource.ShouldContain("new ImagePreviewerDesignTokenDataGrid()");
