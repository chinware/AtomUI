...
public class ImagePreviewerShowCasePageTests
{
    ...
    public void ImagePreviewer_ShowCase_Uses_Document_Layout_With_Examples()
    {
        ...
        source.ShouldContain("Sources=\"{Binding DefaultImages}\"");
        source.ShouldContain("Source=\"{Binding RemoteImage}\"");
        source.ShouldContain("<atom:SkeletonImage IsActive=\"True\"");
        source.ShouldContain("FallbackSource=\"{Binding FallbackImage}\"");
        source.ShouldContain("Sources=\"{Binding ThreeImages}\"");
        source.ShouldContain("CoverIndex=\"1\"");
        source.ShouldNotContain("CoverSource");
        source.ShouldContain("Sources=\"{Binding TwoImages}\"");
        source.ShouldContain("Sources=\"{Binding TwentyRemoteImages}\"");
        source.ShouldNotContain("SourceUri=\"");
        source.ShouldNotContain("SourceUris=\"");
        source.ShouldNotContain("FallbackSourceUri=\"");
        source.ShouldContain("MaxConcurrentLoads=\"4\"");
