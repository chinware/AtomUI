...
public class ButtonSpinnerShowCasePageTests
{
    ...
    public void ButtonSpinner_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("ButtonSpinnerShowCaseLangResource ScenarioApi");
        source.ShouldContain("ButtonSpinnerShowCaseLangResource ScenarioDesignToken");
    ...
    public void ButtonSpinner_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        ...
        codeBehindSource.ShouldContain("new ButtonSpinnerApiDataGrid()");
        codeBehindSource.ShouldContain("new ButtonSpinnerDesignTokenDataGrid()");
