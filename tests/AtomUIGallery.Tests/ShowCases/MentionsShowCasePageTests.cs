...
public class MentionsShowCasePageTests
{
    ...
    public void Mentions_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        ...
        codeBehindSource.ShouldNotContain("new MentionsApiDataGrid()");
        codeBehindSource.ShouldNotContain("new MentionsDesignTokenDataGrid()");
    ...
    public void Mentions_ShowCase_Localization_Includes_Page_And_Api_Copy()
    {
        ...
        foreach (var source in new[] { en, zhCn, zhTw })
        {
            ...
            source.ShouldContain("P2PlaceholderTextLarge");
            source.ShouldContain("P2PlaceholderTextMiddle");
            source.ShouldContain("P2PlaceholderTextSmall");
