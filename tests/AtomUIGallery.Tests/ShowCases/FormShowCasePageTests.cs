...
public class FormShowCasePageTests
{
    ...
    public void Form_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("FormShowCaseLangResource ScenarioApi");
        source.ShouldContain("FormShowCaseLangResource ScenarioDesignToken");
    ...
    public void Form_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        ...
        codeBehindSource.ShouldContain("new FormApiDataGrid()");
        codeBehindSource.ShouldContain("new FormDesignTokenDataGrid()");
