...
public class PaginationShowCasePageTests
{
    ...
    public void Pagination_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("PaginationShowCaseLangResource InfoNamespaceLabel");
        source.ShouldContain("PaginationShowCaseLangResource InfoPackageLabel");
        source.ShouldContain("PaginationShowCaseLangResource InfoBaseClassLabel");
        ...
        source.ShouldContain("PaginationShowCaseLangResource ScenarioExamples");
        source.ShouldContain("PaginationShowCaseLangResource ScenarioApi");
        source.ShouldContain("PaginationShowCaseLangResource ScenarioDesignToken");
        ...
        source.ShouldContain("Text=\"{gallery:PaginationShowCaseLangResource PageDescription}\"");
    ...
    public void Pagination_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        ...
        codeBehindSource.ShouldContain("new PaginationApiDataGrid()");
        codeBehindSource.ShouldContain("new PaginationDesignTokenDataGrid()");
