...
public class SpinShowCasePageTests
{
    ...
    public void Spin_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("SpinShowCaseLangResource ScenarioApi");
        source.ShouldContain("SpinShowCaseLangResource ScenarioDesignToken");
    ...
    public void Spin_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        ...
        codeBehindSource.ShouldContain("new SpinApiDataGrid()");
        codeBehindSource.ShouldContain("new SpinDesignTokenDataGrid()");
