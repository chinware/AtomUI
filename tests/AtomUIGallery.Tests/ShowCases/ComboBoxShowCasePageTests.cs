...
public class ComboBoxShowCasePageTests
{
    ...
    public void ComboBox_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("ComboBoxShowCaseLangResource ScenarioApi");
        source.ShouldContain("ComboBoxShowCaseLangResource ScenarioDesignToken");
    ...
    public void ComboBox_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        ...
        codeBehindSource.ShouldContain("new ComboBoxApiDataGrid()");
        codeBehindSource.ShouldContain("new ComboBoxDesignTokenDataGrid()");
