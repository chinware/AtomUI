...
{
    [Fact]
    public void DropdownButton_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("DropdownButtonShowCaseLangResource ScenarioApi");
        source.ShouldContain("DropdownButtonShowCaseLangResource ScenarioDesignToken");
        ...
        CountOccurrences(source, "DataTemplate x:DataType=\"vm:DropdownButtonViewModel\"").ShouldBe(4);
    ...
    [Fact]
    public void DropdownButton_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        var pageSource       = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Navigation/DropdownButton/Views/DropdownButtonShowCase.axaml");
        var codeBehindSource = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Navigation/DropdownButton/Views/DropdownButtonShowCase.axaml.cs");
        var apiSource        = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Navigation/DropdownButton/Views/DropdownButtonApiDataGrid.axaml");
        var apiCodeSource    = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Navigation/DropdownButton/Views/DropdownButtonApiDataGrid.axaml.cs");
        var tokenSource      = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Navigation/DropdownButton/Views/DropdownButtonDesignTokenDataGrid.axaml");
        var tokenCodeSource  = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Navigation/DropdownButton/Views/DropdownButtonDesignTokenDataGrid.axaml.cs");
        ...
        codeBehindSource.ShouldContain("new DropdownButtonApiDataGrid()");
        codeBehindSource.ShouldContain("new DropdownButtonDesignTokenDataGrid()");

        apiSource.ShouldContain("<atom:DataGrid");
        apiSource.ShouldContain("x:DataType=\"viewModels:DropdownButtonApiRow\"");
        ...
        apiSource.ShouldContain("DropdownButtonShowCaseLangResource ApiColumnProperty");
        apiSource.ShouldContain("DropdownButtonShowCaseLangResource ApiColumnDescription");
        apiSource.ShouldContain("DropdownButtonShowCaseLangResource ApiColumnType");
        apiSource.ShouldContain("DropdownButtonShowCaseLangResource ApiColumnDefault");
        ...
        tokenSource.ShouldContain("x:DataType=\"viewModels:DropdownButtonDesignTokenRow\"");
        ...
        tokenSource.ShouldContain("DropdownButtonShowCaseLangResource TokenColumnToken");
        tokenSource.ShouldContain("DropdownButtonShowCaseLangResource TokenColumnDescription");
        tokenSource.ShouldContain("DropdownButtonShowCaseLangResource TokenColumnScope");
        tokenSource.ShouldContain("DropdownButtonShowCaseLangResource TokenColumnStatus");
    ...
    [Fact]
    public void DropdownButton_ShowCase_Localization_Includes_Page_And_Api_Copy()
    {
        var en   = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Navigation/DropdownButton/Localization/en_US.cs");
        var zhCn = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Navigation/DropdownButton/Localization/zh_CN.cs");
        var zhTw = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/Navigation/DropdownButton/Localization/zh_TW.cs");
        ...
        foreach (var source in new[] { en, zhCn, zhTw })
        {
            ...
            source.ShouldContain("ApiPropertyMenuItemClicked");
