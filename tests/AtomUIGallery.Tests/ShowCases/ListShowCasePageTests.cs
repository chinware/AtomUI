...
{
    [Fact]
    public void List_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("ListShowCaseLangResource ScenarioApi");
        source.ShouldContain("ListShowCaseLangResource ScenarioDesignToken");
    ...
    [Fact]
    public void List_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        var pageSource       = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/DataDisplay/List/Views/ListShowCase.axaml");
        var codeBehindSource = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/DataDisplay/List/Views/ListShowCase.axaml.cs");
        var apiSource        = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/DataDisplay/List/Views/ListApiDataGrid.axaml");
        var apiCodeSource    = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/DataDisplay/List/Views/ListApiDataGrid.axaml.cs");
        var tokenSource      = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/DataDisplay/List/Views/ListDesignTokenDataGrid.axaml");
        var tokenCodeSource  = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/DataDisplay/List/Views/ListDesignTokenDataGrid.axaml.cs");
        ...
        apiSource.ShouldContain("ListShowCaseLangResource ApiColumnProperty");
        apiSource.ShouldContain("ListShowCaseLangResource ApiColumnDescription");
        apiSource.ShouldContain("ListShowCaseLangResource ApiColumnType");
        apiSource.ShouldContain("ListShowCaseLangResource ApiColumnDefault");
        ...
        tokenSource.ShouldContain("x:DataType=\"viewModels:ListDesignTokenRow\"");
        ...
        tokenSource.ShouldContain("ListShowCaseLangResource TokenColumnToken");
        tokenSource.ShouldContain("ListShowCaseLangResource TokenColumnDescription");
        tokenSource.ShouldContain("ListShowCaseLangResource TokenColumnScope");
        tokenSource.ShouldContain("ListShowCaseLangResource TokenColumnStatus");
    ...
    [Fact]
    public void List_ShowCase_Localization_Includes_Page_And_Api_Copy()
    {
        var en   = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/DataDisplay/List/Localization/en_US.cs");
        var zhCn = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/DataDisplay/List/Localization/zh_CN.cs");
        var zhTw = ReadRepoFile("controlgallery/AtomUIGallery/ShowCases/DataDisplay/List/Localization/zh_TW.cs");
