...
public class TabStripShowCasePageTests
{
    ...
    public void TabStrip_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("TabStripShowCaseLangResource InfoNamespaceLabel");
        source.ShouldContain("TabStripShowCaseLangResource InfoPackageLabel");
        source.ShouldContain("TabStripShowCaseLangResource InfoBaseClassLabel");
        ...
        source.ShouldContain("Text=\"{gallery:TabStripShowCaseLangResource PageDescription}\"");
