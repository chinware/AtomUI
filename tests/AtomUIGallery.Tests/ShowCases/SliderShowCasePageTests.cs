...
public class SliderShowCasePageTests
{
    ...
    public void Slider_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("SliderShowCaseLangResource InfoNamespaceLabel");
        source.ShouldContain("SliderShowCaseLangResource InfoPackageLabel");
        source.ShouldContain("SliderShowCaseLangResource InfoBaseClassLabel");
        ...
        source.ShouldContain("SliderShowCaseLangResource ScenarioExamples");
        source.ShouldContain("SliderShowCaseLangResource ScenarioApi");
        source.ShouldContain("SliderShowCaseLangResource ScenarioDesignToken");
        ...
        source.ShouldContain("Text=\"{gallery:SliderShowCaseLangResource PageDescription}\"");
    ...
    public void Slider_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        ...
        codeBehindSource.ShouldContain("new SliderApiDataGrid()");
        codeBehindSource.ShouldContain("new SliderDesignTokenDataGrid()");
