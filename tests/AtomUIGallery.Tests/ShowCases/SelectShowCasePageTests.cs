...
public class SelectShowCasePageTests
{
    ...
    public void Select_ShowCase_Uses_Document_Layout_With_Examples_And_Tables()
    {
        ...
        source.ShouldContain("SelectShowCaseLangResource ScenarioApi");
        source.ShouldContain("SelectShowCaseLangResource ScenarioDesignToken");
        ...
        CountOccurrences(source, "DataTemplate x:DataType=\"vm:SelectViewModel\"").ShouldBe(14);
    ...
    public void Select_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        ...
        codeBehindSource.ShouldContain("new SelectApiDataGrid()");
        codeBehindSource.ShouldContain("new SelectDesignTokenDataGrid()");
