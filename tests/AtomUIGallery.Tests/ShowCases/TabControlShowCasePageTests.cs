...
public class TabControlShowCasePageTests
{
    ...
    public void TabControl_ShowCase_Lazy_Loads_Api_And_DesignToken_DataGrids()
    {
        ...
        codeBehindSource.ShouldNotContain("new TabControlApiDataGrid()");
        codeBehindSource.ShouldNotContain("new TabControlDesignTokenDataGrid()");
    ...
    public void TabControl_ShowCase_Localization_Includes_Page_And_Api_Copy()
    {
        ...
        foreach (var source in new[] { en, zhCn, zhTw })
        {
            ...
            source.ShouldContain("ApiPropertyTabActivationTrigger");
            ...
            source.ShouldContain("ApiEventTabReordering");
            source.ShouldContain("ApiEventTabReordered");
