...
public class ThemeLegacyApiRemovalTests
{
    ...
    public void Legacy_Theme_Types_Are_Physically_Removed()
    {
        ...
        var removedTypeNames = new[]
        {
            ...
            "AtomUI.Theme.TokenSystem.ControlTokenConfigInfo",
            "AtomUI.Theme.TokenSystem.IDesignToken",
            "AtomUI.Theme.TokenSystem.IControlDesignToken",
            "AtomUI.Theme.TokenSystem.TokenConfigBuckets"
        };
